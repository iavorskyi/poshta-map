...
import { CurrentPaymentsFilter } from "../../current-payments/CurrentPaymentsFilter";
import { CurrentPaymentsTable } from "../../current-payments/CurrentPaymentsTable";
import { AddCurrentPayment } from "../../current-payments/AddCurrentPayment";
...
export default async function EditPensionerPage({
  ...
  const canEdit = canEditPensioner(me, pensioner);
