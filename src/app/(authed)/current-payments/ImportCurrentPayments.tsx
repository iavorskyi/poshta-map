            ...
            <>
              <div className="text-sm text-fg-muted space-y-1">
                <p>
                  ...
                  <strong>Будинок</strong>, Квартира (опц.),{" "}
                  <strong>День</strong> (1..31), <strong>Сума</strong>,
                  Виплачено (так/ні). Пенсіонер шукається за ФІО + адресою —
                  спершу точно, потім з допуском на одруківки; якщо вказана
                  квартира, шукаємо насамперед серед її жителів. Рішення
                  (прив&apos;язати до існуючого / створити нового) підтверджується
                  вручну на наступному кроці.
                </p>
                <p>
