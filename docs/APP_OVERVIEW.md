...
- Помилки розпізнавання **будинку** (`ambiguous`/`none`) — критичні: рядок не імпортується, треба виправити у файлі та повторити
