...
- `canManageDistrict` / `canManagePayments` / `canManagePostmen` / `canImport` — **тільки адмін**
...
## 14. Бізнес-нюанси та реальні ребра
...
> Документ актуальний на 2026-05-31. Останній production-комміт: `68cfb94` («Scope home stats to pensioners assigned to current postman»).
